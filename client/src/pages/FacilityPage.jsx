            ...
            {loading ? (
                ...
                facility && (
                    <>
                        ...
                        <div className="self-center max-w-5xl p-3 w-full">
                            {Array.isArray(facility.images) && facility.images.length > 0 ? (
                                <div className="relative h-56 sm:h-64 xl:h-80 2xl:h-96 w-full overflow-hidden rounded-lg shadow">
                                    ...
                                    <button
                                        onClick={() =>
                                            setCurrentIndex((prev) => (prev - 1 + facility.images.length) % facility.images.length)
                                        }
                        ...
                        {/* Description */}
                         <div dangerouslySetInnerHTML={{__html: facility && facility.description}} className="p-2 max-w-2xl mx-auto w-full my-7 post-content"></div>
                    </>
                )
            )}
        </div>
