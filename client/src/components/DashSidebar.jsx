...
import { HiArrowSmRight, HiDocumentText, HiUser, HiOutlineUserGroup, HiChartPie, HiAnnotation } from 'react-icons/hi'
                ...
                <SidebarItemGroup className='flex flex-col gap-1'>
...

                    {
                        ...
                        <Link to='/dashboard?tab=facilities'>
                            <SidebarItem active={tab === 'facilities'} icon={HiDocumentText} as='div'>Facilities</SidebarItem>
                        </Link>
                    }
